...
export const heroOne = {
  ...
  description:
    "Vừa làm vừa học trau dồi bản thân và cũng để giúp khách hàng những gì gọi là tốt nhất.",
...
export const heroThree = {
  ...
  inverse: true,
  topLine: {
    text: "Tôi mạnh dạng nói tôi có độ uy tín cao",
  },
  headline: "Tại sao ? ",
  description:
    "Tôi đã có web giới thiệu về bản thân cùng với tất cả địa chỉ cụ thể,và đang học và có trình độ cử nhân tại trường đại học Nha trang.",
  buttonLabel: "Email",
